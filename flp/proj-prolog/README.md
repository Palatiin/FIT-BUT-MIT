...
The times were measured on school server merlin.
...
```shell
time ./flp23-log < tests/test_blank_in_rule.in
...
real	0m0.019s
user	0m0.010s
sys	0m0.006s
...
```shell
time ./flp23-log < tests/test_blank_on_tape.in
...
real	0m0.018s
user	0m0.007s
sys	0m0.009s
...
```shell
time ./flp23-log < tests/test_left_shift.in
...
```shell
time ./flp23-log < tests/test_not_F.in
...
```shell
time ./flp23-log < tests/test_stuck.in
